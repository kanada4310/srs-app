...
export const handler: Handler = async (event) => {
  ...
  console.log("NETLIFY_BLOBS_SITE_ID:", process.env.NETLIFY_BLOBS_SITE_ID);
  console.log("NETLIFY_BLOBS_TOKEN:", process.env.NETLIFY_BLOBS_TOKEN);
  console.log("NETLIFY_BLOBS_SITE_ID:", process.env.NETLIFY_BLOBS_SITE_ID);
  console.log("NETLIFY_BLOBS_TOKEN:", process.env.NETLIFY_BLOBS_TOKEN);
  const key = crypto.randomUUID(); // Added a comment to force rebuild
